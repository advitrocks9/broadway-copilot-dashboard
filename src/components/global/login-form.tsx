  ...
  return (
    <div className={cn("flex flex-col gap-6", className)}>
      <div className="flex flex-col items-center gap-3">
        ...
        <div className="text-center text-sm text-muted-foreground">Admin Dashboard</div>
      </div>
...
function SubmitButton({
  ...
  return (
    <Button type="submit" className="w-full" disabled={isPending} aria-busy={isPending} aria-live="polite">
